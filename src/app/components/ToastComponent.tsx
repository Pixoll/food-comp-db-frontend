...
export const ToastComponent: React.FC<ToastComponentProps> = ({
  ...
  return (
    <div
      className={`pointer-events-none fixed ${getPositionClasses()} z-[50] w-[100%] max-w-[600px] transition-all duration-[300ms] ease-in-out scale-[1] opacity-[1] ${show ? "" : "scale-[0.95] opacity-[0]"}`}
    >
      <div className="pointer-events-auto shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] rounded-[0.5rem] overflow-hidden border-[0] max-h-[calc(80vh)] overflow-y-auto">
        ...
        <div
          className={`${config.bgOpacity} p-[16px] text-[1.25rem] text-[#1f2937] overflow-y-auto max-h-[400px]`}
