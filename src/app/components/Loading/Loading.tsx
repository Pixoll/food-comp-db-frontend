...
export default function Loading({
    ...
    const bounceStyle = (delay: string): CSSProperties => ({
        ...
        return (
            <div className={`${containerClasses} ${className}`}>
                <div className="animate-spin flex items-center space-x-[4px] ">
                    <div className="w-[6px] h-[6px] bg-[#d1d5db] rounded-full" style={bounceStyle("0ms")}/>
                    <div className="w-[6px] h-[6px] bg-[#9ca3af] rounded-full" style={bounceStyle("150ms")}/>
                    <div className="w-[6px] h-[6px] bg-[#ffffff] rounded-full" style={bounceStyle("300ms")}/>
                </div>
                {text && (
