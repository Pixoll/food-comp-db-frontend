    ...
    return (
        <div ref={containerRef} className={`w-full h-full`}>
            <button
                ...
                className="flex items-center justify-between w-full px-[12px] py-[8px] text-[14px] bg-[white] border-[1px] rounded-[6px] shadow-sm hover:bg-[#f9fafb] focus:outline-none focus:ring-2 focus:ring-[#53bb63] focus:border-[#53bb63]"
        ...
        <span className={`block truncate pr-[6px] ${!selectedValue ? 'text-[#9ca3af]' : 'text-[#4b5563]'}`}>
          {selectedValue || placeholder}
            ...
            {isOpen && (
                <div
                    className="fixed z-[50] bg-[white] border border-[#d1d5db] rounded-[6px] shadow-lg overflow-auto max-h-[240px] box-content"
                    style={{
                ...
                >
                    <div className="sticky top-[0px] z-[10] bg-[white] border-[1px] border-[#e5e7eb]">
                        <input
                            ...
                            className="w-full px-[12px] py-[8px] text-[14p] focus:outline-none focus:ring-2 focus:ring-[#53bb63]"
                            placeholder="Buscar..."
                        />
                    </div>
                    ...
                    {filteredOptions.length > 0 ? (
                        ...
                        >
                            {filteredOptions.map((option) => (
                                <li
                                    key={option.id}
                                    className={`cursor-pointer select-none relative py-[8px] pl-[0px] hover:bg-[#dff2d2] hover:rounded-[3px] ${
