    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex justify-center mb-[24px]">
                ...
                <span
                  ...
                  {data.type.charAt(0).toUpperCase() + data.type.slice(1)}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-[16px] w-[16px] mr-[4px]" fill="none"
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-[16px] w-[16px] mr-[6px]" fill="none"
                                 viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            ...
            <div className="flex justify-center mt-[8px]">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-[18px] w-[18px] mr-[8px]" fill="none"
                         viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
