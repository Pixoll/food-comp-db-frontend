...
export default function AddSubspeciesPage() {
    ...
    const filteredSubspecies = searchTerm
        ? subspecies.filter(s => s.name.toLowerCase().includes(searchTerm.toLowerCase()))
        : subspecies;

    return (
        <div className="h-auto bg-gradient-to-b from-[#f0f9ff] to-[#d8f7b8] p-[24px]">
            <div className="max-w-[1000px] bg-[#ffffff] mx-auto rounded-[12px] shadow-[0_8px_30px_rgba(0,0,0,0.12)] overflow-hidden">
                ...
                <div className="p-[32px]">
                    <div className="mb-[32px]">
                        <h2 className="text-[20px] font-[600] text-[#1f2937] mb-[16px]">Buscar Subespecies Existentes</h2>
                        ...
                        <div className="mt-[20px] max-h-[300px] overflow-y-auto pr-[8px]">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[16px]">
                                {filteredSubspecies.size > 0 ? (
                                    filteredSubspecies.map((s) => (
                                        <div key={s.id} className="p-[16px] border-[1px] border-[#e5e7eb] rounded-[8px] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)] hover:border-[#166534] transition-all duration-[200ms] cursor-pointer">
                    ...
                    <div className="mt-[32px] pt-[32px] border-t-[1px] border-[#e5e7eb]">
                        ...
                        <div className="mb-[20px]">
                            ...
                            <div className="flex flex-wrap gap-[16px]">
                                <button
                                    className="flex items-center bg-[#f0fdf4] text-[#166534] border-[1px] border-[#166534] py-[10px] px-[20px] rounded-[6px] font-[500] hover:bg-[#dcfce7] transition-colors duration-[200ms]"
                                >
                                ...
                                <button
                                    className="flex items-center bg-[#166534] text-[#ffffff] py-[10px] px-[20px] rounded-[6px] font-[500] hover:bg-[#14532d] transition-colors duration-[200ms] shadow-[0_2px_4px_rgba(0,0,0,0.1)]"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-[18px] h-[18px] mr-[8px]">
                        ...
                        <p className="text-[14px] text-[#6b7280] mt-[16px] bg-[#f3f4f6] p-[12px] rounded-[6px]">
                            <span className="font-[600]">Nota:</span> Antes de agregar una nueva subespecie, verifica que no exista en el sistema para evitar duplicados.
                        </p>
                    </div>
                </div>
            </div>
