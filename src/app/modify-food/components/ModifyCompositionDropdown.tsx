...
type DataType = NutrientMeasurement["dataType"];
...
type ModifyCompositionDropdownProps<F extends FormState> = {
    nutrientData: NutrientsValue;
    formState: F;
    onUpdateFormState: (newFormState: F) => void;
    isEditable?: boolean;
};

export default function ModifyCompositionDropdown<F extends FormState>({
    nutrientData,
    formState,
    onUpdateFormState,
