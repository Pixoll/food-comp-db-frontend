                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <button
                                ...
                                hover:shadow-[0_12px_32px_rgba(22,163,74,0.4)]
                                "
                            >
                        ...
                        <div className="space-y-[32px]">
                            <div className="flex justify-center">
                                <div
                                    ...
                                    border-[#16a34a]/[0.2]
                                    rounded-[50px]
                                    shadow-[0_4px_16px_rgba(22,163,74,0.15)]
                                    "
                                >
                                    <div
                                        className="
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            >
                                                <span
                                                    ...
                                                    text-[14px]
                                                    font-[700]
                                                    shadow-[0_2px_8px_rgba(22,163,74,0.3)]
                                                    "
                                                >
                                                    {food.code}
                                                </span>
                                                <button
                                                    ...
                                                    hover:shadow-[0_4px_12px_rgba(220,38,38,0.3)]
                                                    "
                            ...
                            <div className="flex justify-center pt-[16px]">
                                <button
                                    ...
                                    text-[18px]
                                    rounded-[50px]
                                    shadow-[0_8px_32px_rgba(22,163,74,0.4)]
                                    hover:shadow-[0_12px_40px_rgba(22,163,74,0.5)]
                                    hover:from-[#15803d]
                                    hover:to-[#166534]
                                    transform
                                    hover:scale-[1.05]
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    flex-col
                                    lg:flex-row
                                    items-start lg:items-center justify-between gap-[16px]"
                                >
                                    <div>
                                        <h2
                                            className="
                                    ...
                                    <div className="flex flex-wrap gap-[12px]">
                                        <button
                                            ...
                                            hover:shadow-[0_6px_20px_rgba(22,163,74,0.4)]
                                            transform
                                            hover:scale-[1.02]
                                            "
                                ...
                                {foodsResult.status === FetchStatus.Failed && (
                                    <div className="py-[60px] text-center">
                                        <div
                                            ...
                                            max-w-[600px]
                                            mx-auto
                                            shadow-[0_8px_24px_rgba(248,113,113,0.2)]
                                            "
                                        >
                                            <div
                                                className="
