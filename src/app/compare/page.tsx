        ...
        <div className="min-h-full h-full bg-gradient-to-br from-[#aff5af] via-[#eff9ef] to-[#def9de] relative ">
            ...
            <div className="h-full relative z-10 container mx-auto px-[16px] py-[24px] max-w-[1400px]">
                ...
                {comparisonFoods.length < 2 ? (
                    ...
                    >
                        <div
                            className="absolute inset-0 bg-gradient-to-br from-[#f8fafc] via-transparent to-[#f1f5f9] opacity-[0.7]"
                        ></div>
                        ...
                        {!comparisonSectionOpen ? (
                            <div className="space-y-[32px]">
                                <div className="flex justify-center">
                                    ...
                                    >
                                        <div
                                            className="w-[12px] h-[12px] bg-[#16a34a] rounded-[50%] mr-[12px] animate-pulse"
                                        ></div>
                                ...
                                >
                                    {comparisonFoods.map((food, index) => (
                                        ...
                                        >
                                            <div
                                                className="absolute inset-0 bg-gradient-to-br from-[#f8fafc]/[0.8] via-transparent to-[#f1f5f9]/[0.6] opacity-0 group-hover:opacity-100 transition-opacity duration-[400ms]"
                                            ></div>
                                    ...
                                    {foodsResult.status === FetchStatus.Loading && (
                                        ...
                                        >
                                            <div className="relative">
                                                <div
                                                    className="inline-block animate-spin rounded-[50%] h-[60px] w-[60px] border-[4px] border-[#f3f4f6] border-t-[#16a34a] shadow-[0_4px_16px_rgba(22,163,74,0.2)]"
                                                ></div>
                                                <div
                                                    className="absolute inset-0 inline-block animate-spin rounded-[50%] h-[60px] w-[60px] border-[4px] border-transparent border-r-[#22c55e] animation-delay-[150ms]"
                                                ></div>
                                            </div>
